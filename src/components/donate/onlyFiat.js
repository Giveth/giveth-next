  ...
  return (
    <Flex sx={{ flexDirection: 'column' }}>
      <Flex sx={{ width: '450px', flexDirection: 'column' }}>
        ...
        >
          Transak is a fiat on-ramp that allows you to donate with a credit card just as easily as
          you would make a purchase online.
        </Text>
        <Text
          sx={{
            variant: 'text.medium',
        ...
        >
          You&apos;ll be redirected to Transak&apos;s page where your &ldquo;purchase&ldquo; will be
          sent as sent as crypto to the project&apos;s donation address.
        </Text>
      </Flex>
